...
export const PUBLIC_CLAIMS: PublicClaim[] = [
  {
    ...
    value: "750",
    unit: "kg+",
    fullText: "Exafuse reports more than 750 kg of LMD components in total for the Duisburg pedestrian bridge, including six structural nodes and handrail elements.",
    sourceType: "exafuse-public",
    sourceUrlKey: "cs15",
    confidence: "publicly-supported",
    lastReviewed: "2026-09-23",
    allowedPages: ["/", "/about", "/de", "/public-work", "/industrial-proof", "/domains/lmd-ded", "/public-work/exafuse/duisburg-bridge-components"],
  ...
  },
  {
    ...
    value: "6",
    unit: "nodes",
    fullText: "Exafuse's published Duisburg project includes six structural nodes, alongside handrail elements.",
    sourceType: "exafuse-public",
    sourceUrlKey: "cs15",
    confidence: "publicly-supported",
    lastReviewed: "2026-09-23",
  ...
  },
  {
    ...
    value: "219",
    unit: "h",
    fullText: "Exafuse's Duisburg production record gives 219 hours for Knoten 10. This is one node's build duration, not an unattended-duration claim.",
    sourceType: "exafuse-public",
    sourceUrlKey: "cs15",
    confidence: "publicly-supported",
